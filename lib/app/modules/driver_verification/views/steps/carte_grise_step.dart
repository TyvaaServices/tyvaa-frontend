...
class CarteGriseStep extends StatelessWidget {
  final DriverVerificationController controller;

  const CarteGriseStep({Key? key, required this.controller}) : super(key: key);
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Carte Grise', style: TTypography.headingLarge(context)),
                  const SizedBox(height: TSpacing.sm),
                  Text(
                    'Prenez des photos claires de votre carte grise',
                  ...
                  GestureDetector(
                    onTap: () => controller.pickCarteGriseFront(),
                    child: Obx(
                      () =>
                          controller.carteGriseFrontImage.value == null
                              ? _buildUploadContainer(
                                ...
                                isError:
                                    controller
                                        .hasAttemptedNextWithoutCarteGriseFront
                                        .value,
                              ...
                              : _buildImagePreview(
                                ...
                                onRemove:
                                    () =>
                                        controller.removeCarteGriseFrontImage(),
                              ),
                    ),
                  ),
                  ...
                  GestureDetector(
                    onTap: () => controller.pickCarteGriseBack(),
                    child: Obx(
                      () =>
                          controller.carteGriseBackImage.value == null
                              ? _buildUploadContainer(
                                context,
                                'Touchez pour prendre une photo',
                                Icons.add_a_photo_outlined,
                                isError:
                                    controller
                                        .hasAttemptedNextWithoutCarteGriseBack
                                        .value,
                                errorText: 'Photo obligatoire',
                              )
                              : _buildImagePreview(
                                ...
                                onRemove:
                                    () =>
                                        controller.removeCarteGriseBackImage(),
                              ),
                    ),
                  ),

                  if (controller.hasAttemptedNextWithoutCarteGriseFront.value ||
                      controller.hasAttemptedNextWithoutCarteGriseBack.value)
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Assurez-vous que toutes les informations de la carte grise sont clairement visibles',
            ...
            children: [
              ...
              Expanded(
                ...
                child: PrimaryButton(
                  text: 'Continuer',
                  onPressed:
                      () => controller.validateAndProceedFromCarteGriseStep(),
                ),
              ),
            ],
          ),
