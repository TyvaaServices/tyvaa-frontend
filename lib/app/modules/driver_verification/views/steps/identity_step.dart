...
class IdentityStep extends StatelessWidget {
  ...
  const IdentityStep({Key? key, required this.controller}) : super(key: key);
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Prenez des photos claires de votre carte d\'identité ou passeport',
                  ...
                  GestureDetector(
                    onTap: () => controller.pickIdCardFront(),
                    child: Obx(
                      () =>
                          controller.idCardFrontImage.value == null
                              ? _buildUploadContainer(
                                ...
                                isError:
                                    controller
                                        .hasAttemptedNextWithoutIdCardFront
                                        .value,
                              ...
                              : _buildImagePreview(
                                ...
                                onRemove:
                                    () => controller.removeIdCardFrontImage(),
                              ),
                    ),
                  ),
                  ...
                  GestureDetector(
                    onTap: () => controller.pickIdCardBack(),
                    child: Obx(
                      () =>
                          controller.idCardBackImage.value == null
                              ? _buildUploadContainer(
                                ...
                                isError:
                                    controller
                                        .hasAttemptedNextWithoutIdCardBack
                                        .value,
                                errorText: 'Photo obligatoire',
                              )
                              : _buildImagePreview(
                                ...
                                onRemove:
                                    () => controller.removeIdCardBackImage(),
                              ),
                    ),
                  ),

                  if (controller.hasAttemptedNextWithoutIdCardFront.value ||
                      controller.hasAttemptedNextWithoutIdCardBack.value)
                    Padding(
