...
class SplashScreen extends GetView<SplashController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Get.theme.brightness == Brightness.dark? AppColors.darkBackground : AppColors.background,
      body: Center(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() => AnimatedDefaultTextStyle(
                ...
                child: Text("TYVAA",style: TextStyle(color: AppColors.primary),),
              )),
            ],
          ),
        )),
