...
class RideDetailsView extends StatelessWidget {
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  rideModel != null ? '${rideModel.price} FCFA' : '-',
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  ride.rideDate,
                  style: TTypography.bodyMedium(context).copyWith(fontWeight: FontWeight.w600),
                ),
                if (rideModel?.isRecurring == true && rideModel?.recurrence != null)
                  ...[
                    const SizedBox(height: 4),
                    Text(
              ...
              Stack(
                children: [
                  Container(
                    ...
                    //       ? Image.network(driver.profileImage., fit: BoxFit.cover)
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Réservation',
            style: TTypography.headingSmall(context).copyWith(fontWeight: FontWeight.w600),
          ),
          ...
          children: [
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 2),
                    Text(
                      ride.ride!.price != null ? '${(int.parse(_numberOfSeatsController.text) * ride.ride!.price!).toInt()} FCFA' : '-',
                      style: TTypography.headingMedium(context).copyWith(fontWeight: FontWeight.w700, color: TColors.success),
                    ),
                  ],
                ),
                Text(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  final ridePrice = ride.ride!.price ?? 0;
                ...
                child: Text(
                  'Réserver maintenant',
                  style: TTypography.bodyMedium(context).copyWith(fontWeight: FontWeight.w600, color: Colors.white),
                ),
              ),
            ),
          ],
  ...
  void _showDriverProfile(BuildContext context, Rideinstance ride) {
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                '${ride.ride!.driver!.driverProfile!.driverNote} (124 avis)',
