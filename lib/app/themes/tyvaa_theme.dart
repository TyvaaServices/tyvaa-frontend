...
class AppColors {
  ...
  static const Color navBackground = Color(0xFFF8F9FB); // Light background for nav
  ...
  static const Color navBackgroundDark = Color(0xFF121212); // Dark background for nav

  // Text colors (Light Mode)
  static const Color textPrimary = Color(0xFF212121);   // Primary text color for light mode
  static const Color textSecondary = Color(0xFF757575); // Secondary text color for light mode
  static const Color textOnPrimary = Colors.white;       // Text on primary background (white)

  // Text colors (Dark Mode)
  static const Color textPrimaryDark = Colors.white;     // Primary text color for dark mode
  static const Color textSecondaryDark = Colors.white70; // Secondary text color for dark mode
...
class AppTextStyles {
  ...
  static TextStyle get h1 => TextStyle(
      ...
      color: AppColors.textPrimary); // For light mode

  static TextStyle get h1Dark => TextStyle(
      fontSize: 32,
      fontWeight: FontWeight.bold,
      color: AppColors.textPrimaryDark); // For dark mode
  ...
  static TextStyle get subtitle1 => TextStyle(
      ...
      color: AppColors.textSecondary); // For light mode

  static TextStyle get subtitle1Dark => TextStyle(
      fontSize: 20,
      fontWeight: FontWeight.w500,
      color: AppColors.textSecondaryDark); // For dark mode
